...
asset_files = ["mit_humanoid/mit_humanoid_fixed_arms.urdf",
               ...
               "bot_elf/urdf/bot_elf_fixarm.urdf",
               ]
asset_names = ['mit_humanoid','bot_elf','bot_elf_fixarm']#'atlas_fixed_upper_body','atlas_v4_arm1','atlas_v4_arm2']
...
for asset in asset_files:
    ...
    # if asset.endswith('.urdf'):
    #     current_asset = gym.load_asset(sim, asset_root, asset)
    # else:
    #     current_asset = gym.load_mjcf(sim, asset_root, asset)
...
for i in range(len(loaded_assets)):
    pose.p = gymapi.Vec3(0.0, 0.93, i)
    pose.r = gymapi.Quat(-0.707107, 0.0, 0.0, 0.707107)
    # if i == 6:
    #     pose.p = gymapi.Vec3(0.0, 0.51775218743115348, i * 2)
    #     pose.r = gymapi.Quat(1,0,0,0)
